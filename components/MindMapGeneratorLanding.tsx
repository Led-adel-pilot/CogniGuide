...
const faqs = [
  {
    question: 'Is this mind map generator free?',
    answer:
      "Yes, CogniGuide offers a free plan so you can generate interactive mind maps online without paying a cent.",
  },
  {
    question: 'Can I create a mind map from a text file?',
    answer:
      'Absolutely. Paste text or upload PDFs and documents—CogniGuide\'s AI transforms them into mind maps instantly.',
  },
  {
    question: 'Do I need to sign up to use the mind map maker?',
    answer:
      'No sign-up is required to try the generator. Jump straight into the interface and see your map appear in seconds.',
  },
  {
    question: 'What makes this the best mind map maker for students?',
    answer:
      "CogniGuide pairs mind maps with spaced-repetition flashcards so learners stay organized and remember what matters most.",
  },
];
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="w-full h-16 flex items-center justify-between px-4 sm:px-6 lg:px-10">
          ...
          <nav className="flex items-center gap-4">
            <Link href="/mind-map-generator" className="hidden text-sm text-primary font-medium sm:inline">
              Mind Map Generator
            </Link>
                ...
                <div className="text-center lg:text-left">
                  ...
                  <div className="mt-6 flex justify-center lg:justify-start">
                    <div className="inline-flex flex-col items-center gap-1">
                      ...
                      >
                        Generate Your Mind Map Now
                      </button>
                      <p className="text-sm text-muted-foreground">Free to start. No sign-up required.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <p className="text-base md:text-lg text-muted-foreground">
                Join thousands of students who have generated over <span className="font-semibold text-foreground">10,000+</span> mind maps.
              </p>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Automatic mind map generator</p>
                    <p>Save hours of manual formatting with instant branching powered by AI.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2.5 w-2.5 rounded-full bg-primary" aria-hidden="true" />
                  <div>
                    <p className="font-semibold text-foreground">Mind map generator from text, PDFs, and slides</p>
          ...
          <div className="container">
            <div className="max-w-3xl">
              <h2 className="text-3xl md:text-4xl font-bold font-heading tracking-tight">
                More Than a Mind Map Maker: Your Go-To Concept Map Creator
              </h2>
              <p className="mt-4 text-muted-foreground text-lg leading-relaxed">
        ...
        <section className="py-16 md:py-20">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold font-heading tracking-tight">The Perfect Mind Map Tool for Every Learner</h2>
        ...
        <section className="py-16 md:py-20 bg-muted/20 border-t">
          <div className="container max-w-4xl">
            ...
            <div className="mt-8 space-y-4">
              {faqs.map((faq) => (
                <details key={faq.question} className="group rounded-2xl border bg-background p-6" open={faq.question === faqs[0].question}>
            ...
            <div className="mt-10 flex flex-col items-center">
              ...
              >
                Start Creating Mind Maps for Free
              </button>
      ...
      <footer className="border-t bg-muted/40">
        <div className="container py-3 flex flex-col md:flex-row justify-between items-center gap-2">
          ...
          <nav className="flex flex-wrap justify-center gap-2 sm:gap-4">
            <Link href="/mind-map-generator" className="text-xs text-muted-foreground/70 hover:underline md:hidden">
              Mind Map Generator
            </Link>
