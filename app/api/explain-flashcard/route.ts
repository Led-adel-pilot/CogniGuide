...
- For complex words write them, then write next to them between () a simpler synonyme or a short explanation.
...
- Start by writing the question in bold and if it needs to be simplified do so, then follow with the explanation.
