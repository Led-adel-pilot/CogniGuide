...
- Once uploads finish, CogniGuide “prepares” the content by extracting text, diagrams, and prompts behind the scenes so the AI can create something meaningful without manual intervention.
...
- Credit usage is metered: 1 credit covers roughly 3,800 characters of processed content. Image-only requests start at half a credit, and even prompt-only generations charge a minimum of 1 credit. (Anonymous visitors get 3 free generations before they need an account.)
- Plans include a Free tier (100 monthly credits), Student tier (1,200 monthly credits), and Pro tier (1,800 monthly credits). Every plan unlocks the same core features; the paid plans simply lift content limits and refresh credits more generously.
...
- Pricing copy highlights three options:
   1. **Free** – Designed for newcomers, it awards 100 credits per month (plus three anonymous trials) so everyone can experience mind map + flashcard generation via the fast model, spaced repetition, and the ability to kick off study sessions before upgrading; AI flashcard explanations remain reserved for paid plans.
   2. **Student** – The most popular plan at **$9.99 per month** or **$99.90 per year** (10× monthly) delivers 1,200 credits every month, exam-aware scheduling, AI flashcard explanations, and access to Smart Model generations for richer output while keeping the interface focused on study prep.
   3. **Pro** – At **$14.99 per month** or **$149.90 per year** (10× monthly) it provides 1,800 credits per month for power users who process large book chapters, certifications, or professional content; it unlocks the same AI flashcard explanations and Smart Model support as Student but with maximum throughput, plus the dashboard shows a “current plan” state for easier upgrades.
