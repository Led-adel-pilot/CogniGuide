...
- **MindMapModal** (not shown above) visualises streamed Markmap Markdown, exporting to SVG/PNG/PDF through html-to-image and jspdf integrations, coordinates KaTeX rendering, node interactions, and share/export affordances. (See file for exact UI flows.)【F:components/MindMapModal.tsx†L1-L200】
